...
public class FconcertActivity extends AppCompatActivity {
    TextView  txtView;
    EditText txtSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        concertAdapter = new ConcertAdapter(FconcertActivity.this, concertList);
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!keyword.isEmpty()) {
                    ...
                    Toast.makeText(FconcertActivity.this, "검색어를 입력해주세요", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void fetchConcertList(int page, int limit) {
        isLoading = true;
        Call<ConcertLike> call = likeApi.getAllConcert(page, limit);
        call.enqueue(new Callback<ConcertLike>() {
            ...
            public void onResponse(Call<ConcertLike> call, Response<ConcertLike> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(FconcertActivity.this,
                            "데이터를 가져오는데 실패",
    ...
    private void searchConcerts(String keyword) {
        ...
        call.enqueue(new Callback<ConcertRes>() {
            ...
            public void onResponse(Call<ConcertRes> call, Response<ConcertRes> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if ("success".equals(result)) {
                        ...
                        Toast.makeText(FconcertActivity.this, "검색 결과를 가져오는데 실패", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(FconcertActivity.this, "검색 결과를 가져오는데 실패", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ConcertRes> call, Throwable t) {
                Toast.makeText(FconcertActivity.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
